...
float HCSR04_Read(void) {
    ...
    local_time = DWT->CYCCNT - start_time;

    // Convert time to microseconds
    float time_us = (float)local_time / (SystemCoreClock / 1000000.0f);

    // Distance in cm = (time_us / 2) * 0.0343
